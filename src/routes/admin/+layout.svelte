...
<div class="lg:pl-72">
				...
				<div class="flex items-center gap-x-4 lg:gap-x-6">
					...
					<el-dropdown class="relative">
						...
						>
							<a
								href={resolve('/')}
								class="block px-3 py-1 text-sm/6 text-gray-900 focus:bg-gray-50 focus:outline-hidden dark:text-white dark:focus:bg-gray-700"
								>Your profile</a
							>
							<a
								href={resolve('/')}
	...
	<main class="min-h-screen bg-stone-100 py-10">
