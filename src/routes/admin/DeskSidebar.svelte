		...
		<nav class="flex flex-1 flex-col">
			<ul role="list" class="flex flex-1 flex-col gap-y-7">
				<li>
					<ul role="list" class="-mx-2 space-y-1">
						<li>
							...
							<a
								href={resolve('/admin')}
								class="group flex gap-x-3 rounded-md bg-gray-50 p-2 text-sm/6 font-semibold text-stone-600 dark:bg-white/5 dark:text-white"
							>
								<svg
									viewBox="0 0 24 24"
									fill="none"
									...
									data-slot="icon"
									aria-hidden="true"
									class="size-6 shrink-0 text-stone-600 dark:text-white"
								>
									<path
				...
				<li class="mt-auto">
					<a
						href={resolve('/')}
						class="group -mx-2 flex gap-x-3 rounded-md p-2 text-sm/6 font-semibold text-gray-700 hover:bg-gray-50 hover:text-stone-600 dark:text-gray-300 dark:hover:bg-white/5 dark:hover:text-white"
					>
						<svg
							viewBox="0 0 24 24"
							fill="none"
